              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-[#2a2414] border-b border-[#3a2d10]">
                    <th colSpan="3" className="px-4 py-2 font-heading text-center text-xs tracking-[0.2em] uppercase text-[#c9a84c]">
                      {team.teamName}
                    </th>
                  </tr>
                </thead>
                <tbody className="font-body text-sm text-[#7a6848]">
                  {(team.players || []).map((player, playerIdx) => (
                    <tr key={`t${teamIdx}-p${playerIdx}`} className="border-b border-[#3a2d10]/50 last:border-none hover:bg-[#1e1a0d]/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-center"><span title={player.fuerza} className="inline-flex items-center justify-center">{fuerzaIcons[player.fuerza] || player.fuerza}</span></td>
                      <td className="px-4 py-3 text-center">
